...
class CNNModel(nn.Module):
    def __init__(self, hidden_size, drop_out, input_length=13, *args, **kwargs):
        """
        Args:
...
class ImprovedBinaryCNN(nn.Module):
    def __init__(self, hidden_size, input_size=1, drop_out=0.5):
        ...
        self.transition3 = nn.Sequential(
            nn.Conv1d(64, 256, kernel_size=3, stride=1, padding=1, bias=False),
            nn.BatchNorm1d(256),
            nn.GELU(),
            nn.MaxPool1d(kernel_size=2),
            nn.Dropout(drop_out),
