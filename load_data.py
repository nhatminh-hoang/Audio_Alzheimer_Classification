...
test_folder = "./processed/test"
val_folder = "./processed/val"
...
print("Train labels:", Counter([label.item() for _, label in train_loader.dataset]))
print("Val labels:", Counter([label.item() for _, label in val_loader.dataset]))
